...
urlpatterns = [
    ...
    path('user/<int:id>/followers/', FollowersView.as_view(), name='accounts-user-followers'),
    path('user/<int:id>/following/', FollowingView.as_view(), name='accounts-user-following'),
]